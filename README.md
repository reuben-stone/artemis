...
- **Swappable brains** - a `ModelClient` seam routes turns to the Claude API or a **local
  model** via Ollama (your laptop or a dedicated brain box).
...
An ongoing personal engineering project, built and dogfooded on a real multi-repo product
ecosystem. The source is public for inspection and technical evaluation.

Engineering case study: https://www.reubenstone.co.uk/work/artemis
