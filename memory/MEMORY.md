# Artemis — Memory Index

The operator's persistent context store. One fact per markdown file; this index
loads each session. Keep entries to a single line: `- [Title](file.md) — hook`.

<!-- entries appear here as the operator learns about you and your projects -->
